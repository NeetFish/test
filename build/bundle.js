...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = React.createClass({
	    ...
	    protectCon: function protectCon(name) {
	        ...
	        if (this.state['switch']) {
	            return React.createElement(
	                ...
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement(TestOne, { show: true, protectCon: this.protectCon, name: this.state.name })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement(TestTwo, { show: false })
	                ),
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement(TestOne, { show: false, protectCon: this.protectCon, name: this.state.name })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement(TestTwo, { show: true })
	                ),
	                React.createElement('input', { type: 'button', onClick: this._toggle, value: 'Press Me!' }),
	                React.createElement(ToDoList, null)
	            );
	        ...
	        /*
	              return (
	                  <div>
	                      ...
	                      {this.state.switch ? <TestOne protectCon={this.protectCon} name={this.state.name} /> : <TestTwo />}
	                      <ToDoList />
	                  </div>
	              );
	        */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var NaFail = __webpack_require__(160);
	...
	var TestOne = React.createClass({
	    ...
	    changeNa: function changeNa(name) {

	        this.props.protectCon({ name: name });
	        this.setState({ name: name });
	    },
	    render: function render() {

	        if (this.props.show) var show = 'none';else var show = 'initial';
	        ...
	        return(
	            ...
	            React.createElement(
	                'div',
	                { style: { display: show } },
	                React.createElement(NaFail, { changeNa: this.changeNa, name: this.state.name }),
	                React.createElement(
	                    'h1',
	                    null,
	                    this.state.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var ToDoItems = __webpack_require__(163);
	var AddNewItem = __webpack_require__(164);
	var DeleteItem = __webpack_require__(165);
	...
	var ToDoList = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(ToDoItems, { todoItems: this.state.todoItems }),
	      React.createElement(AddNewItem, { addItem: this.addItem }),
	      React.createElement(DeleteItem, { delItem: this.deleteItem })
	    );
	  }
	});
	...
	var AddNewItem = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'button', onClick: this.handleClick, value: "Add item" })
	    );
	  }
	});
	...
	var DeleteItem = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      null,
	      React.createElement('input', { onChange: this.handleChange }),
	      React.createElement('input', { type: 'button', onClick: this.handleClick, value: "Delete item" })
	    );
	  }
	});
